...
def _update_weights(agent_interface: "AgentInterface", pid: PolicyID):
...
class AgentInterface:
    ...
    def __post_init__(self):
        ...
        self.sample_dist = self.sample_dist or {}
    ...
    def set_behavior_dist(self, distribution: Dict[PolicyID, float]):
    ...
    def add_policy(
        ...
        :param policy_id: PolicyID, policy id
        :param policy_description: Dist[str, Any], policy description, used to create policy instance
        :param parameter_desc: ParameterDescription, parameter description, used to coordinate with parameter server
        """
    ...
    def transform_observation(self, observation: Any, policy_id: PolicyID = None):
        ...
        :param observation: Any, raw environment observation
        :param pid: PolicyID, default by None, if specified, agent will switch to policy tagged with `pid`.
