...
from malib.utils.typing import AgentID, Dict, Any, Tuple, List, ActionSpaceType
...
class vectorization(VectorEnv):
    def __init__(self, env_desc: Dict[str, Any], num_envs: int):
        super().__init__(env_desc, num_envs)

    def reset(self) -> Any:
        return super().reset()

    def step(self, actions: List[ActionSpaceType]) -> Tuple[Dict, Dict, Dict, Dict]:
