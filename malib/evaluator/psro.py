...
class PSROEvaluator(BaseEvaluator):
    ...
    def __init__(self, **config):
        ...
        stop_metrics = config["stop_metrics"]
    ...
    def evaluate(
        ...
        # FIXME(ming): agents from the same iteration print different values of `self._iteration`
        # print(
        #     f"Evaluation result on iteration: {self._iteration}:\n{pretty_print(res)}"
        # )
