...
class SimpleEvaluator(BaseEvaluator):
    ...
    def __init__(self, **config):
        # XXX(ziyu): since we implement different evaluator
        #  why we need specify stopping metrics
        stop_metrics = config.get("stop_metrics", "simple")
        super().__init__(stop_metrics)
